      ...
      <div className="container">
        <div className="row">
          ...
          >
            ...
            <p>
              Lava <a href="#">HTML landing page</a> template is provided by{" "}
              <a href="#">TemplateMo</a>. You can modify and use it for your
            ...
            <li data-scroll-reveal="enter right move 30px over 0.6s after 0.5s">
              ...
              <div className="text">
                ...
                <p>
                  ...
                  from our website. Duis viverra, ipsum et scelerisque placerat,
                  orci magna consequat ligula.
                </p>
              </div>
            </li>
        ...
        <div className="col-lg-8 offset-lg-2">
          <div className="center-heading">
            ...
            <p>
              ...
              purus non, convallis odio. Donec vitae magna ornare, pellentesque
              ex vitae, aliquet urna.
            </p>
          </div>
        </div>
        <div
          ...
          <div className="owl-carousel owl-theme">
            ...
            <div className="item service-item">
              ...
              <div className="testimonial-content">
                ...
                <h4>Martino Tino</h4>
                <p>
                  “Morbi non mi luctus felis molestie scelerisque. In ac libero
                  viverra, placerat est interdum, rhoncus leo.”
                </p>
